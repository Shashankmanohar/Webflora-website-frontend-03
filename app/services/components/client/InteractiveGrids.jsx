  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
    {benefits.map((b, i) => (
      <motion.div 
        key={i}
        whileHover={{ y: -5 }}
        className="group relative p-10 rounded-[2rem] border border-white/5 bg-[#080808] overflow-hidden"
      >
  ...
  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
    {techStack.map((tech, i) => (
      <motion.div 
        ...
        className="group p-8 rounded-2xl border border-white/5 bg-white/[0.01] hover:border-[#FF3B00]/40 transition-all cursor-default"
      >
